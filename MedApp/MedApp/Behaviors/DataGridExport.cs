        ...
        public static void ExportDataGrid(object sender)
        {
            ...
            if (currentGrid != null)
            {
                ...
                try
                {
                    ...
                    {
                        foreach (DataGridColumn dataGridColumn in currentGrid.Columns.Where(dataGridColumn => dataGridColumn.Visibility == Visibility.Visible ||  dataGridColumn.Visibility == Visibility.Hidden))
                        {
